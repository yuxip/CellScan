...
// Sun Aug 12 19:44:39 2007 by ROOT version 5.12/00f
// from TChain h112/
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)gDirectory->Get("h112");

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("h112","");
      chain->Add("~heppel/Example2/roottemp/run7116007.10.root/h112");
      chain->Add("~heppel/Example2/roottemp/run7116007.11.root/h112");
      chain->Add("~heppel/Example2/roottemp/run7116007.12.root/h112");
      chain->Add("~heppel/Example2/roottemp/run7116007.13.root/h112");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t h112::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t h112::LoadTree(Long64_t entry)
{
